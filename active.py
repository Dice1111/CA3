...
while main_program == True:
    ...
    # .....................................record.......................................
        ...
        if record_name in swimmers:
            ...
            if record_event_type_detail in swimmers[record_name]['Event'] and record_time in swimmers[record_name]['Time'] and record_meet in swimmers[record_name]['Meet']:
                ...
                elif swimmers[record_name]['Event'] == [] and swimmers[record_name]['Time'] == [] and swimmers[record_name]['Meet'] == []:
                     swimmers[record_name]['Event'].append(record_event_type_detail)
                     swimmers[record_name]['Time'].append(record_time)
                     swimmers[record_name]['Meet'].append(record_meet)
